...
public class KafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, VaccinationDto> producerFactory() {
    ...
    @Bean
    public KafkaTemplate<String, VaccinationDto> kafkaTemplate(ProducerFactory<String, VaccinationDto> producerFactory) {
